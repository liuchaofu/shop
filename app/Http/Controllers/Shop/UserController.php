...
//                      dd($shops);
                        //登录成功
                        return redirect()->route("shop.sp.index")->with("success", "登录成功");
//                        return view("shop.user.index",compact("shops"))->with("success", "登录成功");

                    }elseif($mm[0]->status == "0"){
                        //正在审核
                        return redirect()->route("shop.sp.wait");
                    }else{
                        //被禁用
                        return "over";
                    }
                    ...
                    return redirect()->route("shop.sp.add");
                }
...
//        $id = Auth::id();
//        //显示自己的那个商家信息
//        $shops = DB::table("shops")->where("user_id","=",$id)->first();
//
////        dd($shops);
